...
<body>
  ...
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <iframe src="https://map.kakao.com/?sName=+동양미래대학교+&eName=+홍콩반점고척동양대점&target=walk" 
      id="the_iframe" onload="calcHeight();" frameborder="0" scrolling="no" style="overflow-x:hidden; overflow:auto; width:100%; min-height:500px;">
	</iframe>
    </div>
  </div>
</div>
